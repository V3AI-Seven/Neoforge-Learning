package net.mrseven.learningmod;

import net.minecraft.world.item.CreativeModeTabs;
import net.minecraft.world.item.MobBucketItem;
import net.mrseven.learningmod.block.ModBlocks;
import net.mrseven.learningmod.item.ModCreativeModeTabs;
...
public class LearningMod {
    ...
    @EventBusSubscriber(modid = LearningMod.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
